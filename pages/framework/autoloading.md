...
description: 'Автозагрузка классов. Документация по Bitrix Framework: принципы работы, архитектура и примеры использования.'
---
...
Подробнее в статье [Composer](./../get-started/composer.md).
