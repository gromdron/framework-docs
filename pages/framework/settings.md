...
description: 'Конфигурация ядра. Документация по Bitrix Framework: принципы работы, архитектура и примеры использования.'
---
...
Подробнее в статье [Логгеры](./../advanced/logger.md).
