...
description: 'Установка окружения. Пошаговое руководство по началу работы с Bitrix: установка, структура проектов и базовые принципы.'
---
...
1. Создайте пул сервера *1\. Create Management pool of server*. После создания пула пункт заменится на *1\. Manage servers in the pool* и станет доступно полное меню. Откроются порты для работы продуктов:
...
Подробнее в статье [Установка 1С-Битрикс: Управление сайтом и коробочной версии Битрикс24 на другие окружения](https://dev.1c-bitrix.ru/learning/course/index.php?COURSE_ID=135&CHAPTER_ID=020866).
